# CLAUDE.md — 80 Days to Stay

> **80 Days to Stay: What AI Can and Can't Do** — a 5-course graduate series in Bear Brown & Company. Each course develops a specific tier of human intelligence that AI cannot replicate.

## Who this site is for
80 Days to Stay is the companion site for a graduate certificate program at Bear Brown & Company. It serves as the public-facing hub for course descriptions, research blog posts, interactive tools, and developer documentation.
...
## Author
**Nik Bear Brown**, Bear Brown & Company. Creator of the 80 Days to Stay curriculum and this platform.
...
15. `/privacy` — Privacy Policy for 80 Days to Stay
16. `/privacy/cookies` — Cookie Policy for 80 Days to Stay (dedicated page)
17. `/terms-of-service` — Terms of Service for 80 Days to Stay
...
- **Program Info:** 80 Days to Stay, Bear Brown & Company, Bear Brown & Company, bear@bearbrown.co
...
1. **Hero** (two-column): Left — h1 "80 Days to Stay", subtext "What AI Can and Can't Do", program description, "Explore Courses" + "Contact Us" buttons. Right — introductory video embed.
...
- Program introduction (80 Days to Stay at Bear Brown & Company)
...
## Legal Pages — DONE
All three pages use the same structural template, branded for 80 Days to Stay. Bear Brown & Company, Bear Brown & Company. Contact: bear@bearbrown.co. Educational program.
...
## Theming (80 Days to Stay palette)
...
irreduciblyhuman.xyz is the companion site for "80 Days to Stay: What AI Can and Can't Do," a 5-course graduate certificate in Bear Brown & Company. It runs on Next.js with Vercel auto-deploy. The public site has no login; the admin dashboard is cookie-protected.
...
**Courses** (`/courses`) — Card grid of the five courses in the 80 Days to Stay sequence. Click a course to read its full description.
...
1. Rebrand Header, Footer, Home page, and About page to 80 Days to Stay
2. Build `/courses` directory page and five individual course pages
3. Update legal pages (Privacy, Cookies, Terms) for 80 Days to Stay branding
4. Update color palette for 80 Days to Stay branding
