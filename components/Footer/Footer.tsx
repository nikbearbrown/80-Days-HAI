      ...
      <div className="container px-4 md:px-6 mx-auto py-10">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-semibold">80 Days to Stay</h3>
        ...
        <div className="mt-8 pt-6 border-t text-center text-sm text-muted-foreground">
          <p>&copy; {currentYear} 80 Days to Stay. All rights reserved.</p>
          <p className="mt-2">
            80 Days to Stay is open source (MIT License) · Built by{' '}
