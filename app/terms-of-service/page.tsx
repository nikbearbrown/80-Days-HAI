...
export const metadata: Metadata = {
  title: 'Terms of Service - 80 Days to Stay',
  description: 'Terms of Service for 80 Days to Stay and irreduciblyhuman.xyz',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Company:</strong> 80 Days to Stay</li>
          ...
          <section className="mb-8">
            ...
            <p>
              80 Days to Stay provides educational content and course materials. The irreduciblyhuman.xyz website serves as an informational resource, tool directory,
          ...
          <section className="mb-8">
            ...
            <p>
              80 Days to Stay offers educational resources, course materials, and research content related to AI and human intelligence. All engagements are governed by
              separate agreements between 80 Days to Stay and the participant. These Terms apply to use of this
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              and software, is the property of 80 Days to Stay or its content suppliers and is protected by
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              ...
              by 80 Days to Stay at any time.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              80 Days to Stay. These articles are provided for convenient reading and are attributed to their original
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              GitHub, Vercel, Neon, and Anthropic. 80 Days to Stay does not guarantee the accuracy,
              relevance, timeliness, or completeness of any information on these external services. Please note that
              80 Days to Stay is not responsible for the content, privacy practices, or availability of these external
          ...
          <section className="mb-8">
            ...
            <p>
              The materials on 80 Days to Stay&apos;s website are provided &ldquo;as is&rdquo; and &ldquo;as available.&rdquo;
              80 Days to Stay makes no warranties, expressed or implied, and hereby disclaims and negates all other
            ...
            <p className="mt-4">
              ...
              80 Days to Stay does not warrant that the website will be uninterrupted, error-free, or free of harmful
              components.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              In no event shall 80 Days to Stay or its partners be liable for any damages (including, without
              limitation, damages for loss of data or profit, or due to business interruption) arising out of the use
              or inability to use the materials on this website, even if 80 Days to Stay or an authorised representative
          ...
          <section className="mb-8">
            ...
            <p>
              You agree to indemnify and hold harmless 80 Days to Stay, its partners, and its affiliates from any
          ...
          <section className="mb-8">
            ...
            <p>
              The materials appearing on 80 Days to Stay&apos;s website could include technical, typographical, or
              photographic errors. 80 Days to Stay does not warrant that any of the materials on its website are accurate,
              complete, or current. 80 Days to Stay may make changes to the materials contained on its website at any time
              without notice.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              80 Days to Stay may revise these Terms of Service at any time without notice. By using this website, you
          ...
          <section className="mb-8">
            ...
            <p>
              If you have any questions about these Terms, please contact 80 Days to Stay:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
