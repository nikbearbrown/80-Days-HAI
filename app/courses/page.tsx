...
export const metadata: Metadata = {
  title: "Courses - 80 Days to Stay",
  description: "The 80 Days to Stay course sequence from Bear Brown & Company. Each course develops a specific tier of human intelligence that AI cannot replicate.",
};
