...
export const metadata: Metadata = {
  title: 'About - 80 Days to Stay',
  description: '80 Days to Stay — What AI Can and Can\'t Do. A 5-course series from Bear Brown & Company.',
}
    ...
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          <section>
            <p>
              80 Days to Stay is a 5-course series from Bear Brown &amp; Company.
