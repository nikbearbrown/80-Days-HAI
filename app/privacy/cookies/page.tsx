...
export const metadata: Metadata = {
  title: 'Cookie Policy - 80 Days to Stay',
  description: 'Cookie policy for 80 Days to Stay and irreduciblyhuman.xyz',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              ...
              This Cookie Policy explains how <strong>80 Days to Stay</strong> uses cookies and similar technologies on{' '}
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions about our use of cookies, please contact 80 Days to Stay:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
