...
export const metadata: Metadata = {
  title: 'Privacy Policy - 80 Days to Stay',
  description: 'Privacy policy for 80 Days to Stay and irreduciblyhuman.xyz',
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to <strong>irreduciblyhuman.xyz</strong>, operated by <strong>80 Days to Stay</strong>. We are committed to protecting your
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              We encourage you to review the privacy policies of these third-party services. 80 Days to Stay is not
          ...
          <section className="mb-8">
            ...
            <p>
              If you have questions or comments about this privacy policy, please contact 80 Days to Stay:
            </p>
            <ul className="list-none pl-0 mt-4 space-y-1 text-base">
              <li><strong>Email:</strong>{' '}
                <a href="mailto:bear@bearbrown.co" className="text-primary hover:underline">bear@bearbrown.co</a>
