...
export const metadata: Metadata = {
  title: 'Videos - 80 Days to Stay',
  description: 'Video tutorials, lectures, and educational content from 80 Days to Stay.',
}
  ...
  return (
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold tracking-tighter mb-4">80 Days to Stay</h1>
